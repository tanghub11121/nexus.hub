...
ImageButton.Image = "rbxassetid://112612480151400"

UICorner.Parent = ImageButton
UICorner.CornerRadius = UDim.new(1, 0)  -- ทำให้ปุ่มเป็นวงกลม

ClickSound.Parent = ImageButton
ClickSound.SoundId = "rbxassetid://112612480151400"
ClickSound.Volume = 1
...
local Window = Fluent:CreateWindow({
    Title = "Nexus Hub",
    SubTitle = "Fisch Beta by Xesonz/Rain/Config",
    TabWidth = 160,
